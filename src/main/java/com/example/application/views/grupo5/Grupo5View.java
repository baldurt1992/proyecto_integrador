...
public class Grupo5View extends VerticalLayout {
    ...
    public HorizontalLayout algoritmo1() {
        ...
        vl1.add(new Image("https://firebasestorage.googleapis.com/v0/b/imagenes-dd8e6.appspot.com/o/volumenes_geometricos1.png?alt=media&token=5273b7a5-3347-4711-88ad-558c202f8b77&_gl=1*1pxz0zm*_ga*MzAzMzU0MjM2LjE2OTQ2MTYwNDY.*_ga_CW55HF8NVT*MTY5NjM3NDI5NC4xMC4xLjE2OTYzNzQzOTAuNjAuMC4w", ""));
        ...
        select.addValueChangeListener(event ->{ // usamos addValueChangeListener para escuchar los cambios de selección en el Select
...
calcular.addClickListener(event -> {
    ...
    public double calcularVolumen(String figura, double parametro1, double parametro2, double alturaPiramide) {
        ...
        public HorizontalLayout algoritmo2() {
            ...
            VerticalLayout vl1 = new VerticalLayout();
            vl1.setAlignItems(Alignment.CENTER);
            vl1.add(new Image("https://firebasestorage.googleapis.com/v0/b/imagenes-dd8e6.appspot.com/o/areatriangulo.png?alt=media&token=75bdc776-6fe6-4a12-a0a0-427f24735e79&_gl=1*13v5p03*_ga*MzAzMzU0MjM2LjE2OTQ2MTYwNDY.*_ga_CW55HF8NVT*MTY5Njk4MTIzMS4xNy4wLjE2OTY5ODEyMzEuNjAuMC4w", ""));
            ...
            calcular.addClickListener(event -> {
                ...
                String numeroFormateado = String.format("%.2f", area); //para formatear el resultado que sea a 2 cifras decimales
        ...
        public HorizontalLayout algoritmo3() {
            ...
            VerticalLayout vl1 = new VerticalLayout();
            vl1.setAlignItems(Alignment.CENTER);
            vl1.add(new Image("https://firebasestorage.googleapis.com/v0/b/imagenes-dd8e6.appspot.com/o/trangulosEyI.png?alt=media&token=0d131aee-fafb-4f68-aac6-115fd4e50678&_gl=1*6jisvy*_ga*MzAzMzU0MjM2LjE2OTQ2MTYwNDY.*_ga_CW55HF8NVT*MTY5NzE0NDc2OS4yMy4wLjE2OTcxNDQ3NjkuNjAuMC4w", ""));
            ...
            calcular.addClickListener(event -> {
                ...
                if(figura == "Equilátero"){
                    ...
                    numeroFormateado = String.format("%.2f", areaEqui); //para formatear el resultado que sea a 2 cifras decimales
                    resultado.setText(String.valueOf("El área es: " + numeroFormateado+ " cm2"));
                }else if(figura == "Isósceles"){
                    areaIso = (valorParametro1 / 2) * Math.sqrt(Math.pow(valorParametro2, 2) - Math.pow(valorParametro1 / 2, 2));
                    numeroFormateado = String.format("%.2f", areaIso); //para formatear el resultado que sea a 2 cifras decimales
                    resultado.setText(String.valueOf("El área es: " + numeroFormateado+ " cm2"));
                }
